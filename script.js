...
const account1 = {
  owner: "Jessica Davis",
  movements: [5000, 340, -150, -790, -3210, -100, 850, -30],
  interestRate: 1.5,
  pin: 2222,
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const hour = `${movDate.getHours()}`.padStart(2, "0");
    const minute = `${movDate.getMinutes()}`.padStart(2, "0");
    const html = `
      <div class="movements__row">
        <div class="movements__type movements__type--${type}">${type}</div>
    <div class="movements__date">${day}/${month}/${year} ${hour}:${minute}</div>
